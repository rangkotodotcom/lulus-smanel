...
<fieldset>
	...
	<form action="" method="post">
		...
		<div class="form-group">
			...
			<textarea name="kritik" id="kritik" class="form-control" rows="3" placeholder="tulis kritik di sini" required></textarea>
		</div>
		<div class="form-group">
			<label for="saran">Saran</label>
			<textarea name="saran" id="saran" class="form-control" rows="3" placeholder="tulis saran di sini" required></textarea>
		</div>
