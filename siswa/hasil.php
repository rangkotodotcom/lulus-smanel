...
<fieldset>
	...
	<script>
		...
		function lihat() {
			document.getElementById("hasil").innerHTML = "<div style='margin:50px 0; padding:20px 0; font-size:20px; border:2px solid; background-color:#faebd7; border-radius:20px;'><h1 align='center'>Anda Dinyatakan <span style='color:#b22222; font-size:60px;'><?= $data['ket']; ?></span> Dari Sekolah Menengah Atas Negeri 1 ENAM LINGKUNG.<br> Silahkan Cek Data Diri Anda Pada Menu Data Diri.<br> Silahkan Cetak Surat Keterangan Kelulusan Pada Menu Nilai UN.<br> Silahkan Cetak Surat Rincian Nilai Pada Menu Rapor & USBN.</h1></div>";
		}
	</script>
