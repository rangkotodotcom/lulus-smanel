<fieldset>
	...
	<form action="" method="post" enctype="multipart/form-data">
		<table class="table table-striped" width="100%">
			...
			<tr>
				<td>Tanggal Lahir</td>
				<td>:</td>
				<td><input type="date" name="tgl_lhr" placeholder="22 September 1998" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td>No Peserta</td>
				<td>:</td>
				<td><input type="text" name="no_pes" placeholder="12-0xxx-xxxx-x" /></td>
			</tr>
			<tr>
				<td>Kelas</td>
				<td>:</td>
				<td><input type="text" name="Kelas" placeholder="IPA/IPS" /></td>
			</tr>
			<tr>
				<td>Foto</td>
				<td>:</td>
	...
	if(isset($_POST['tambah'])){
		if($nama == "" || $t_lahir == "" || $tgl_lhr == "" || $n_ortu == "" || $nis == "" || $nisn == "" || $no_pes == "" || $nama_foto == "" || $kelas == ""){
			?>
			...
			if($upload){
				mysqli_query($conn, "INSERT INTO t_ld_siswa VALUES('$nama', '$t_lahir', '$tgl_lhr', '$n_ortu', '$nis', '$nisn',  '$no_pes', '$kelas', '$nama_foto_baru')");
