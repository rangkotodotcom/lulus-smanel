...
<fieldset>
	...
	<form action="" method="post" enctype="multipart/form-data">
		<table class="table table-striped" width="100%">
			...
			<tr>
				<td>Tanggal Lahir</td>
				<td>:</td>
				<td><input type="date" name="tgl_lhr" value="<?= $data['tgl_lhr']; ?>" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					...
					<a href="?page=<?= base64_encode("d_siswa"); ?>" class="btn btn-warning btn-sm">
	...
	if(isset($_POST['edit'])){
		if($nama == "" || $t_lahir == "" || $tgl_lhr == "" || $n_ortu == "" || $nis == "" || $nisn == "" || $no_pes == "" || $kelas == ""){
			?>
			...
			if($nama_foto == ""){
				mysqli_query($conn, "UPDATE t_ld_siswa SET nama = '$nama', t_lahir = '$t_lahir', tgl_lhr = '$tgl_lhr', n_ortu = '$n_ortu', nis = '$nis', nisn = '$nisn', no_pes = '$no_pes', kelas = '$kelas' WHERE nisn = '$kd' ");
				...
				if($upload){
					mysqli_query($conn, "UPDATE t_ld_siswa SET nama = '$nama', tgl_lhr = '$t_lahir', tgl_lhr = '$tgl_lhr', n_ortu = '$n_ortu', nis = '$nis', nisn = '$nisn', no_pes = '$no_pes', kelas = '$kelas', foto = '$nama_foto_baru' WHERE nisn = '$kd' ");
