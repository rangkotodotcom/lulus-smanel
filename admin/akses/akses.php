...
<fieldset>
	...
	<br><br>
	<p align="center" style="font-size: 20px;">Waktu Pengumuman Adalah<br>
		<div align="center" style="font-size: 16px; width: 50%;">
			<?= tanggal(date("j F Y H:i:s", strtotime($akses['waktu_mundur'])));  ?>

			<form action="" method="post">
				<div class="form-group">
					<label for="tanggal">Edit Waktu Pengumuman</label>
					<input type="date" name="tanggal" id="tanggal" class="form-control" required>
					<input type="time" name="jam" id="tanggal" class="form-control" required>
				</div>
				<button name="simpan" type="submit" class="btn btn-success btn-md">Simpan</button>
			</form>
			...
			if(isset($_POST['simpan'])){
				...
				$waktu_mundur = $tanggal." ".$jam.":00";

				mysqli_query($conn, "UPDATE t_izin_login SET waktu_mundur = '$waktu_mundur' WHERE id = 1 ");
